...
import torch
from transformers import WEIGHTS_NAME, set_seed
...
def main():
    ...
    parser.add_argument('--data_type', default="default")
    parser.add_argument(
    ...
    parser.add_argument("--eval_results_prefix", default=None)
    ...
    try:
        ...
        assert isinstance(block_size, tuple) and len(block_size) == 2, "Invalid block size " + args.block_size
    ...
    if isinstance(args.block_size, int):
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            evaluate(args, model, tokenizer, prefix=prefix,
                     file_prefix=args.eval_results_prefix + "_" if args.eval_results_prefix is not None else "")
